...
namespace MapasGoogle
{
    ...
    {
        [DllImport("C:\\Users\\Usuario\\Desktop\\mapas\\Airport_DLL_BACKEND\\Debug\\Airport_DLL_BACKEND.dll", CallingConvention = CallingConvention.StdCall)]
        ...
        private void AddRoubtn_Click(object sender, EventArgs e)
        {
            if (IDtxt.Text.Length != 0 && DisTXT.Text.Length != 0 && RouteTXT.Text.Length != 0)
            {
                ...
                {                   
                    ...
                    DisTXT.Text = "";
                    /*
                    * Agregar una funcion que obtenga las latituds y lonigtudes del origen y el destino
                    GMapPolygon poly = new GMapPolygon()
                    */
                }
                else
                {
